...
const ENGINS_LOCATION = [
  {
    ...
    icon: "engineering",
    prixJour: 400000,
    desc: "Terrassement, fouilles profondes",
  },
  {
    id: "bulldozer",
    label: "Bulldozer D6",
    icon: "construction",
    prixJour: 500000,
    desc: "Décapage, nivellement de masse",
  },
  {
    id: "grue",
    label: "Camion grue 8T",
    icon: "precision_manufacturing",
    prixJour: 400000,
    desc: "Levage structure, déchargement",
  },
  {
    id: "betonneuse",
    label: "Bétonnière",
    icon: "settings",
    prixJour: 400000,
    desc: "Fondations, dallage, maçonnerie",
  },
  {
    id: "camion-benne",
    label: "Camion benne 15 m³",
    icon: "local_shipping",
    prixJour: 200000,
...
export default function CalculateurBudget() {
  ...
  const waMsg = encodeURIComponent(
    `Bonjour, j'ai utilisé le calculateur Fogatech BTP.\n` +
      ...
      `Estimation : ${formatFCFA(budget.total)} – ${formatFCFA(budget.totalMax)}\n` +
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            <div className="bg-surface border border-outline-variant p-6 space-y-5 rounded-2xl">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-baseline">
                  ...
                  <span className="text-on-surface font-bold text-sm">
                    {formatFCFA(budget.constMin)} – {formatFCFA(budget.constMax)}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-baseline">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-on-surface-variant text-xs">
                      jusqu&apos;à {formatFCFA(budget.totalMax)}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 w-full bg-primary text-on-primary font-bold py-3 hover:bg-primary-container transition-colors rounded-full"
              >
