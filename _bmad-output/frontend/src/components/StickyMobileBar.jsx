...
export default function StickyMobileBar() {
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 flex" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
      <a
      ...
      <a
        ...
        className="flex-1 flex flex-col items-center justify-center gap-1 py-3 bg-[#25D366] border-t border-r border-white/10 active:brightness-90"
        aria-label="Contacter sur WhatsApp"
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-[22px] h-[22px] text-white" aria-hidden="true">
