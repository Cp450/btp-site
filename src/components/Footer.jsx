...
export default function Footer() {
  return (
    <footer className="bg-primary text-white border-t border-white/10">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 py-10 md:py-16 grid grid-cols-2 md:grid-cols-4 gap-12">
        {/* Brand */}
        <div className="col-span-2 md:col-span-1">
          <span className="text-3xl font-headline font-black text-white mb-4 block">Fogatech</span>
          <p className="text-on-primary-container text-sm leading-relaxed font-body mb-4 md:mb-6">
      ...
      {/* WhatsApp CTA */}
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 py-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-on-primary-container text-sm font-body text-center sm:text-left">
          Besoin d'un devis rapide ? Contactez-nous directement sur WhatsApp.
        </p>
        <a
          href="https://wa.me/242069610635?text=Mbote%21%20Je%20souhaite%20un%20devis%20Fogatech%20BTP."
          target="_blank"
          rel="noopener noreferrer"
          className="flex-shrink-0 flex items-center gap-3 bg-[#25D366] text-white font-headline font-bold uppercase tracking-widest text-xs px-6 py-3 rounded-full hover:bg-green-500 transition-colors"
        >
      ...
      <div className="border-t border-white/10">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 flex-wrap">
            <Link to="/confidentialite" className="text-on-primary-container/60 hover:text-white text-xs font-body transition-colors">Politique de Confidentialité</Link>
            <Link to="/mentions-legales" className="text-on-primary-container/60 hover:text-white text-xs font-body transition-colors">Mentions Légales</Link>
            <Link to="/cgu" className="text-on-primary-container/60 hover:text-white text-xs font-body transition-colors">CGU</Link>
          </div>
        </div>
      </div>
    </footer>
