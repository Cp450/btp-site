      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-secondary-container/10 border border-secondary-container/20 rounded-xl p-4 mb-8">
          <p className="text-on-surface-variant text-sm">
            <strong>Avertissement :</strong> Ces conditions sont fournies à titre informatif et doivent être validées par un juriste avant publication définitive.
          </p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface">
            <p>L'accès et l'utilisation du site fogatech.cg impliquent l'acceptation sans réserve des présentes conditions générales d'utilisation. Fogatech BTP se réserve le droit de modifier ces conditions à tout moment. L'utilisateur est invité à les consulter régulièrement.</p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface">
            <p>Fogatech BTP propose les services suivants :</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li><strong>Génie Civil & BTP :</strong> construction de villas, immeubles, bureaux, locaux commerciaux</li>
              <li><strong>Smart City :</strong> éco-cités intelligentes, infrastructures connectées</li>
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface space-y-4">
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li>Une validation écrite par Fogatech BTP</li>
            </ul>
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface">
            ...
            <p className="mt-4"><strong>Garantie de délai :</strong> En cas de retard imputable à Fogatech BTP, une pénalité de 0,5% du montant du contrat par semaine de retard est appliquée, dans la limite de 5% du montant total.</p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface space-y-4">
            <p><strong>Limitation de responsabilité :</strong> Fogatech BTP ne peut être tenu responsable des dommages résultant de :</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <p><strong>Assurances :</strong> Fogatech BTP est assurée pour :</p>
            <ul className="list-disc list-inside space-y-1 ml-4">
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface">
            <p>Tous les contenus du site (textes, images, plans, logos, codes source) sont la propriété exclusive de Fogatech BTP. Toute reproduction, représentation, modification ou adaptation, même partielle, est interdite sans autorisation écrite préalable, conformément aux articles du Code de la propriété intellectuelle.</p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface">
            <p>Fogatech BTP se réserve le droit de modifier les présentes conditions générales à tout moment. Les nouvelles conditions s'appliquent à compter de leur mise en ligne. L'utilisation continue du site vaut acceptation des nouvelles conditions.</p>
          </div>
        </section>
