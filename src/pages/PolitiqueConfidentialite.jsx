      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-secondary-container/10 border border-secondary-container/20 rounded-xl p-4 mb-8">
          <p className="text-on-surface-variant text-sm">
            <strong>Avertissement :</strong> Cette politique de confidentialité est fournie à titre informatif et doit être validée par un juriste avant publication définitive.
          </p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="font-body text-on-surface">
            ...
            <p className="mt-4">Pour exercer ces droits, contactez-nous à : <strong>contact@fogatech.cg</strong></p>
          </div>
        </section>
